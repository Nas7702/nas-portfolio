...
const DOT_VARIANTS: Record<LogoVariant, string[]> = {
  ...
  record: [
    ...
    "dark:via-red-500",
    "dark:to-orange-400",
    "shadow-[0_0_9px_rgba(248,113,113,0.4)]",
    "dark:shadow-[0_0_14px_rgba(248,113,113,0.55)]",
    "before:absolute",
    "before:-inset-[0.45rem]",
    "before:rounded-full",
    "before:bg-[radial-gradient(circle_at_center,_rgba(248,113,113,0.28),_rgba(249,115,22,0.1)_65%,_rgba(249,115,22,0)_100%)]",
    "dark:before:bg-[radial-gradient(circle_at_center,_rgba(248,113,113,0.46),_rgba(244,63,94,0.16)_60%,_rgba(244,63,94,0)_100%)]",
    "before:backdrop-blur-[1.7px]",
    "before:opacity-70",
    "before:transition",
    "before:duration-300",
    "before:ease-out",
    ...
    "after:inset-0",
    "after:rounded-full",
    "after:bg-[radial-gradient(circle_at_center,_rgba(255,255,255,0.5),_rgba(248,113,113,0)_72%)]",
    "after:opacity-0",
    "after:transition",
    "after:duration-200",
    "after:ease-out",
    ...
    "motion-safe:group-hover:after:translate-x-[0.18px]",
    "motion-safe:group-hover:after:-translate-y-[0.2px]",
    "motion-safe:group-focus-visible:after:translate-x-[0.18px]",
    "motion-safe:group-focus-visible:after:-translate-y-[0.2px]",
    "dark:group-hover:shadow-[0_0_18px_rgba(248,113,113,0.52)]",
    "dark:group-focus-visible:shadow-[0_0_18px_rgba(248,113,113,0.52)]",
    ...
    "motion-reduce:group-focus-visible:after:translate-x-0",
    "motion-reduce:group-focus-visible:after:-translate-y-0",
    "motion-reduce:group-hover:shadow-[0_0_10px_rgba(248,113,113,0.32)]",
    "motion-reduce:dark:group-hover:shadow-[0_0_14px_rgba(248,113,113,0.45)]",
    "motion-reduce:group-focus-visible:shadow-[0_0_10px_rgba(248,113,113,0.35)]",
    "motion-reduce:dark:group-focus-visible:shadow-[0_0_14px_rgba(248,113,113,0.48)]",
  ],
};
