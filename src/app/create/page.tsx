...
const featuredMedia: MediaItem[] = [
  {
    ...
    outcome: "An engaging brand film capturing the full resurfacing, from golden-hour prep to the finished reveal.",
    description: "Start-to-finish completion film for ADJ Surfacing's Morrisons Meadowhead car park resurfacing in Sheffield, tracking the job from golden-hour prep and levelling, through an overnight graft under floodlight, to the finished reveal of crisp new bays and fresh markings. Top-down drone, ground camera and a drone time-lapse combine for the widest range of any ADJ film to date, an engaging brand film that captures the scale and precision of the work."
  }
];
...
const portfolioItems: PortfolioItem[] = [
  {
    ...
    date: "2026",
    description: "Completion film for ADJ Surfacing's Morrisons Meadowhead car park resurfacing project in Sheffield, covering the full start-to-finish arc: golden-hour daytime prep and levelling, an overnight graft under floodlight, and the finished reveal of crisp white bays and fresh yellow markings. Top-down drone passes, ground camera and a drone time-lapse combine to give the widest range of any ADJ piece to date. An engaging brand film that captures the scale and precision of the resurfacing.",
  },
  {
    id: "JCB Digger Dance",
    type: "video",
    kind: "video",
    src: "https://pub-92e1443c56394daeb0a2b18a08feffdc.r2.dev/JCB-Digger-Dance-2026-Web.mp4",
    thumbnail: "https://pub-92e1443c56394daeb0a2b18a08feffdc.r2.dev/thumbnail/sq_jcb_digger_dance_thumbnail.webp",
  ...
  {
    id: "CLAAS Summer Harvest",
    type: "video",
    kind: "video",
    src: "https://pub-92e1443c56394daeb0a2b18a08feffdc.r2.dev/Combine-Web.mp4",
    thumbnail: "https://pub-92e1443c56394daeb0a2b18a08feffdc.r2.dev/thumbnail/sq_combine_thumbnail.webp",
    cover: "https://pub-92e1443c56394daeb0a2b18a08feffdc.r2.dev/thumbnail/sq_combine_thumbnail.webp",
    title: "CLAAS: Summer Harvest",
    alt: "CLAAS combine harvester cutting a golden wheat field from the air thumbnail",
    tags: ["Brand Film", "Drone", "Agriculture", "Cinematic"],
    industrial: true,
    client: "CLAAS",
    role: "Director, DP & Editor",
    date: "2026",
    description: "Cinematic brand film for CLAAS, following one of their combine harvesters through a summer wheat harvest. Golden-hour drone work tracks the machine cutting and threshing across the fields, chaff catching the light behind it, cut together with wide aerials of the patchwork landscape and set to cinematic music. Made to show the machine at work with the scale and polish of a manufacturer film.",
  },
  {
    id: "ADJ Warrington",
    type: "video",
    kind: "video",
    src: "https://pub-92e1443c56394daeb0a2b18a08feffdc.r2.dev/ADJ-Warrington-Web.mp4",
    thumbnail: "https://pub-92e1443c56394daeb0a2b18a08feffdc.r2.dev/thumbnail/sq_adj_warrington_thumbnail.webp",
    cover: "https://pub-92e1443c56394daeb0a2b18a08feffdc.r2.dev/thumbnail/sq_adj_warrington_thumbnail.webp",
    title: "ADJ: Warrington",
    alt: "ADJ Surfacing Warrington retail park resurfacing film thumbnail",
    tags: ["Commercial", "Drone", "Corporate Film", "Cinematic"],
    industrial: true,
    client: "ADJ Surfacing & Consultancy Ltd",
    role: "Director, DP & Editor",
    date: "2026",
    description: "Completion film for ADJ Surfacing's resurfacing works at Chetham Court retail park in Warrington. Cinematic drone passes establish the site against the wider retail park, while ground-level coverage follows the paving crew and Vögele paver laying the new surface course. Built as a client-facing asset for pitches and LinkedIn.",
  },
  {
    id: "ADJ Aintree",
    type: "video",
