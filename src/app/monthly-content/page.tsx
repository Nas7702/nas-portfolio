...
import { Video, Camera, Scissors, FileText, Zap, Clock, Calendar, Users, Utensils, Briefcase, ArrowRight, Check } from "lucide-react";
              ...
              {packages.map((pkg, index) => (
                <ScrollReveal key={pkg.id} direction="up" delay={0.1 + index * 0.1}>
                  ...
                  >
                    ...
                    <Link
                      href={`/contact?src=monthly_content&package=${pkg.id}`}
